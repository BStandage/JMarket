...
public class HistoryDialog extends JDialog {
	...
	public HistoryDialog(Buyer u) {
		...
		JLabel nameLabel = new JLabel("Purchase history");
		nameLabel.setBounds(39, 23, 328, 64);
		setFieldLabelLayout(nameLabel);
		contentPanel.add(nameLabel);
		JPanel buttonPane = new JPanel();
		buttonPane.setBounds(0, 535, 507, 99);
		...
		saveButton.setBounds(329, 13, 153, 53);
		...
		scrollPane.setBounds(27, 110, 466, 400);
